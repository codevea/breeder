 ...
 */
final class Version20260223113700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE breeder CHANGE business_page_id business_page_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE breeder CHANGE business_page_id business_page_id INT DEFAULT NULL');
    }
}
